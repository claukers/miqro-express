import { ParseOption, parseOptions, ParseOptionsMode, SimpleMap, SimpleTypes } from "@miqro/core";
...
export const ValidateQueryHandler = ({ options, mode }: ValidateQueryHandlerOptions): NextCallback => {
  return CatchHandler(async (req, res, next) => {
...
export const ValidateParamsHandler = ({ options, mode }: ValidateParamsHandlerOptions): NextCallback => {
  return CatchHandler(async (req, res, next) => {

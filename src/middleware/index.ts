import { CORS, Handler, FeatureToggle, LoggerHandler, ReadBuffer, JSONParser, URLEncodedParser, TextParser } from "@miqro/core";
...
export const middleware = (): Handler[] => {
  ...
  if (FeatureToggle.isFeatureEnabled("CORS", false)) {
    ret.push(CORS());
  }

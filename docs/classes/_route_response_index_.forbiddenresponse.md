[miqro-express](../README.md) › [Globals](../globals.md) › ["route/response/index"](../modules/_route_response_index_.md) › [ForbiddenResponse](_route_response_index_.forbiddenresponse.md)
